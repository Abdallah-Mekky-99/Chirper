    ...
    <form method="POST" action="{{ route('toggle-follow', $user->id) }}" class="m-0">
        ...
        @if ($user->is_followed)
            ...
            <button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1 group-hover/follow:hidden" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="20 6 9 17 4 12"></polyline>
                </svg>
                {{-- Unfollow icon (on hover) --}}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1 hidden group-hover/follow:block"
